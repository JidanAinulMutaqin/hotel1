...
$dp = query("SELECT * FROM datapengunjung WHERE id = $id")[0];
...
<input type="hidden" name="id" value="<?= $dp["id"]; ?>">
  ...
  <div class="col-md-3">
    ...
    <select name="kamar" class="form-select" id="kamar" value="<?= $dp["kamar"]; ?>" required>
      <option selected disabled value="<?= $dp["kamar"]; ?>">Choose...</option>
      <option>01</option>
      <option>02</option>
      <option>03</option>
      <option>04</option>
  ...
  <div class="col-md-2">
    ...
    <input name="cekin" type="date" class="form-control" id="cekin" value="<?= $dp["cekin"]; ?>" required>
  </div>

  <div class="col-md-4">
    <label for="cekout" class="form-label">Check-Out</label>
    <input name="cekout" type="date" class="form-control" id="cekout" value="<?= $dp["cekout"]; ?>" required>
  </div>

  <div class="col-md-3">
    <label for="email" class="form-label">Email</label>
    <input name="email" type="email" class="form-control" id="email" value="<?= $dp["email"]; ?>" required>
  </div>

  <div class="col-12">
    <button class="btn btn-danger" name="submit" type="submit">Simpan</button>
    <a href="guest.php" class="btn btn-danger" >Batal</a>
  </div>
</form>
